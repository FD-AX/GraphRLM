...
para(tf, "Достаёт недостающие звенья доказательной цепочки в контекст AI-research —", 22, TEXT, space_after=2)
...
para(tf, "Все измеряют точность ответа. Полноту доказательной базы — никто.", 20, TEXT, bullet=True, space_after=14)
...
para(tf2, "Мы не просто измеряем полноту — мы достаём в контекст именно то доказательство, которого не хватает.",
...
# ---------------------------------------------------------------- Slide 3
s = slide()
title(s, "Решение: дёшево находим пробел — дорого закрываем, только где он есть")
